(function (e) {
  function t(t) {
    for (
      var o, i, l = t[0], c = t[1], d = t[2], s = 0, h = [];
      s < l.length;
      s++
    )
      ((i = l[s]),
  ...
  ((c.e = function (e) {
    var t = [],
      n = { "chunk-17f86c25": 1, "chunk-1b795919": 1, "chunk-3222d6ee": 1 };
    i[e]
      ? t.push(i[e])
      : 0 !== i[e] &&
        n[e] &&
        t.push(
          (i[e] = new Promise(function (t, n) {
            for (
              ...
              if ("stylesheet" === d.rel && (s === o || s === r)) return t();
            }
            var h = document.getElementsByTagName("style");
            for (l = 0; l < h.length; l++) {
              ((d = h[l]), (s = d.getAttribute("data-href")));
              if (s === o || s === r) return t();
            }
  ...
  var d = (window["webpackJsonp"] = window["webpackJsonp"] || []),
    s = d.push.bind(d);
  ((d.push = t), (d = d.slice()));
  for (var h = 0; h < d.length; h++) t(d[h]);
  var u = s;
  ...
  "1e42": function (e, t, n) {
    ...
    const s = (e, t, n, o, i, r = 0, a = 0, l = []) => {
      ...
      T = (e, t, n = !1, o = !0) => {
        const i = t.nodeData ? t.nodeData : t;
        return (
          (e.data = m(i.data)),
          o ? delete e.data.uid : e.data.uid || (e.data.uid = O()),
          n && (e.data.isActive = !1),
          (e.children = []),
          t.children && t.children.length > 0
            ? t.children.forEach((t, i) => {
                e.children[i] = T({}, t, n, o);
              })
            : t.nodeData &&
              t.nodeData.children &&
              t.nodeData.children.length > 0 &&
              t.nodeData.children.forEach((t, i) => {
                e.children[i] = T({}, t, n, o);
              }),
      ...
      x = (e) => e * (Math.PI / 180),
      S = (e) =>
        e.replace(/([a-z])([A-Z])/g, (...e) => e[1] + "-" + e[2].toLowerCase());
    const A = function (e, t) {
      ...
      N = (e, t, n = 0, o = 0) => {
        let i = e.elRect,
          ...
          { left: d, top: s, width: h, height: u } = t,
          p = (d + h) * r + l,
          g = (s + u) * a + c;
        ((d = d * r + l), (s = s * a + c));
        let m = 0,
        ...
        return (
          d < 0 + n && (m = -d + n),
          p > i.width - n && (m = -(p - i.width) - n),
          s < 0 + o && (f = -s + o),
          g > i.height - o && (f = -(g - i.height) - o),
          { isOuter: 0 !== m || 0 !== f, offsetLeft: m, offsetTop: f }
        );
      };
    let E = null;
    const I = (e) => (
    ...
    const F = (e) =>
      ...
      P = (e) => Object.prototype.toString.call(e).slice(8, -1),
      D = (e) => null === e || void 0 === e || "" === e;
    let _ = null;
    const H = (e) => {
      (_ || (_ = document.createElement("div")), (_.innerHTML = e));
      for (let t = _.childNodes, n = t.length; n--; )
        if (1 == t[n].nodeType) return !0;
      return !1;
    };
    let B = null;
    const z = (e, t, n) => {
      (B || (B = document.createElement("div")), (B.innerHTML = e));
      let o = (e) => {
        let i = e.childNodes;
        i.forEach((i) => {
          1 === i.nodeType
            ...
            : 3 === i.nodeType &&
              e.replaceChild(
                document.createTextNode(
                  i.nodeValue.replace(new RegExp(t, "g"), n),
                ),
                i,
              );
        });
      };
      return (o(B), B.innerHTML);
    };
    const U = (e) => (
        (e = String(e).replace(/\s+/g, "")),
        ["#fff", "#ffffff", "#FFF", "#FFFFFF", "rgb(255,255,255)"].includes(
          e,
        ) || /rgba\(255,255,255,[^)]+\)/.test(e)
      ),
      V = (e) => (
        (e = String(e).replace(/\s+/g, "")),
        ["", "transparent"].includes(e) || /rgba\(\d+,\d+,\d+,0\)/.test(e)
      ),
      G = (e) => {
        let { lineColor: t, root: n, second: o, node: i } = e,
          r = [
            t,
            n.fillColor,
            n.color,
      ...
      W = (e) => {
        const t = (e) => {
          ...
          n.forEach((e) => {
            1 === e.nodeType &&
              (e.classList.contains("ql-formula")
        ...
        1 === e.nodeType
          ? (W(e),
            "p" === e.tagName.toLowerCase()
              ? (n += e.textContent + "\n")
              : (n += e.textContent))
          : 3 === e.nodeType && (n += e.nodeValue);
      }
      return n.replace(/\n$/, "");
    };
    let X = null;
    const j = (e) => {
      (X || (X = document.createElement("div")), (X.innerHTML = e));
      ...
      for (let i = 0; i < t.length; i++) {
        const e = t[i];
        1 === e.nodeType
          ? "br" === e.tagName.toLowerCase()
            ? (n.push(o), (o = ""))
            : (o += e.textContent)
          : 3 === e.nodeType && (o += e.nodeValue);
      }
      return (
        o && n.push(o),
        n.map((e) => `<p><span>${pe(e)}</span></p>`).join("")
      );
    };
    let J = null;
    const Z = (e) => {
        (J || (J = document.createElement("div")), (J.innerHTML = e));
        const t = J.querySelectorAll(".ql-formula");
        Array.from(t).forEach((e) => {
          const t = document.createTextNode("$smmformula$");
          e.parentNode.replaceChild(t, e);
        });
        const n = J.childNodes;
        let o = [];
        for (let i = 0; i < n.length; i++) {
          const e = n[i];
          1 === e.nodeType
            ? o.push(e.textContent)
            : 3 === e.nodeType && o.push(e.nodeValue);
        }
        if (
          ((e = o.map((e) => `<p><span>${pe(e)}</span></p>`).join("")),
          t.length > 0)
        ) {
          ((e = e.replace(
            /\$smmformula\$/g,
            '<span class="smmformula"></span>',
          )),
            (J.innerHTML = e));
          const n = J.querySelectorAll(".smmformula");
            ...
            if (P(i) === P(r)) {
              if ("Object" === P(i)) {
                if (JSON.stringify(i) !== JSON.stringify(r))
                  return void (n[o] = r);
              } else if (i !== r) return void (n[o] = r);
            } else n[o] = r;
          }),
          n
        );
      },
      Q = (e) => !/^_/.test(e) && !i["f"].includes(e),
      ee = (e) => {
        const t = [...d["c"]],
          n = Object.keys(e);
        for (let o = 0; o < n.length; o++) if (!t.includes(n[o])) return !1;
        return !0;
      },
      te = (e) =>
        e.reduce((e, t) => {
          const n = e.find((e) => e.type === t.type);
          return (
            n
              ? t.list.forEach((e) => {
                  const t = n.list.find((t) => t.name === e.name);
      ...
      oe = (e) => {
        ...
        e.forEach((e) => {
          ...
          if (o) {
            const i = o.uid;
            n[i] = o;
            const r = e.getIndexInBrothers(),
              a = { node: e, index: r };
            t[i]
              ? t[i].find((e) => e.index === a.index) || t[i].push(a)
              : (t[i] = [a]);
          }
        });
        const o = [];
        return (
          Object.keys(t).forEach((e) => {
            if (t[e].length > 1) {
              const i = t[e].map((e) => e.index).sort((e, t) => e - t);
              o.push({ node: n[e], range: [i[0], i[i.length - 1]] });
            } else o.push({ node: t[e][0].node });
          }),
          o
        );
      },
      ie = (e, t, n, o, i, r, a, l) => t > i && r > e && o > a && l > n,
      re = (e) => {
      ...
      le = (e, t = {}) => {
        t = { ...t };
        const n = t && t.richText;
        n && t.resetRichText && delete t.resetRichText;
        const o = (e) => {
          e.forEach((e) => {
            ((e.data = { ...e.data, ...t }),
      ...
      de = (e) => (e ? (Array.isArray(e) ? e : [e]) : []),
      se = (e) =>
        e.parent
          ? e.parent.nodeData.children.findIndex((t) => t.data.uid === e.uid)
          : 0,
      he = (e, t) => t.findIndex((t) => t.uid === e.uid),
      ue = (e) => {
        let t = 0;
        for (let i = 0; i < e.length; i++) t = e.charCodeAt(i) + ((t << 5) - t);
        const n = new r(t),
          o = n.genrand_int32() % 360;
        return "hsla(" + o + ", 50%, 50%, 1)";
      },
      pe = (e) => (
        [
          ["&", "&amp;"],
      ...
      ye = (e) => {
        ...
        const t = se(e);
        -1 !== t && e.parent.nodeData.children.splice(t, 1);
      },
      ve = (e) => (
        i["i"].forEach((t) => {
          e = e.replace(new RegExp(`<${t}([^>]*)>`, "g"), `<${t} $1 />`);
        }),
        e
      ),
      we = (e, t) => {
        if (e.length !== t.length) return !1;
        for (let n = 0; n < e.length; n++)
          if (!t.find((t) => t.uid === e[n].uid)) return !1;
        return !0;
      },
      be = () => {
      ...
      ke = (e) => ({ simpleMindMap: !0, data: e }),
      Ce = (e) => {
        let t = null;
        if ("string" === typeof e)
          try {
            const n = JSON.parse(e);
            "object" === typeof n && n.simpleMindMap && (t = n.data);
          } catch (o) {}
        else "object" === typeof e && e.simpleMindMap && (t = e.data);
        const n = !!t;
        return { isSmm: n, data: n ? t : String(e) };
      },
      xe = (e, t) => {
        e.preventDefault();
        ...
        (n.deleteFromDocument(),
          (t = t || e.clipboardData.getData("text")),
          (t = pe(t)),
          (t = I(t)));
        const o = t.split(/\n/g),
        ...
        (o.forEach((e, t) => {
          ...
          if ((i.appendChild(n), t < o.length - 1)) {
            const e = document.createElement("br");
            i.appendChild(e);
          }
        }),
          n.getRangeAt(0).insertNode(i),
          n.collapseToEnd());
      },
      Se = (e) => {
        const t = {},
          n = (e, o) => {
            const i = e.data.uid;
            (o && o.children.push(i),
              (t[i] = { isRoot: !o, data: { ...e.data }, children: [] }),
              e.children &&
                e.children.length > 0 &&
      ...
      Ae = (e, t, n, o) => Math.sqrt(Math.pow(e - n, 2) + Math.pow(t - o, 2)),
      Ne = (e, t) => {
      ...
      Ee = ({ addContentToHeader: e, addContentToFooter: t }) => {
        const n = [];
        let o = null,
          i = 0,
          r = null,
        ...
        const l = (e, t) => {
          if ("function" === typeof e) {
            const o = e();
            if (!o) return;
            const { el: i, cssText: r, height: a } = o;
            if (i instanceof HTMLElement) {
              _e(i);
              const e = Pe({ el: i, height: a });
              t(e, a);
            }
            r && n.push(r);
          }
      ...
      Ie = (e, t = 0, n = 0, o = 0, i = 0, r = !1, a = !1) => {
        ...
        const h = (e, t) => {
          ...
          (!a &&
            e._generalizationList.length > 0 &&
            e._generalizationList.forEach((e) => {
              h(e.generalizationNode);
            }),
            e.children &&
              e.children.forEach((e) => {
                h(e);
        ...
        return (
          ...
          (c = c - t + o),
          (s = s - n + i),
          { left: l, top: d, width: c - l, height: s - d }
        );
      },
      Le = (e, t = 0, n = 0, o = 0, i = 0) => {
        let r = 1 / 0,
          a = -1 / 0,
          l = 1 / 0,
          c = -1 / 0;
        return (
          ...
          { left: r, top: l, width: a - r, height: c - l }
        );
      },
      Fe = () =>
      ...
      He = (e) => (
        (e = [...e]),
        e.sort((e, t) => e.sortIndex - t.sortIndex),
        e
      ),
      Be = (e, t) => c()(e, t, { arrayMerge: (e, t) => t }),
      ze = (e) => {
        const t = {};
        return (
          i["h"].forEach((n) => {
            let o = e.style.merge(n);
            ("fontSize" === n && (o += "px"), (t[n] = o));
          }),
          t
        );
      },
  ...
  "365c": function (e, t, n) {
    ...
    const c = "SIMPLE_MIND_MAP_DATA",
      d = "SIMPLE_MIND_MAP_CONFIG",
      s = "SIMPLE_MIND_MAP_LANG",
      h = "SIMPLE_MIND_MAP_LOCAL_CONFIG";
    let u = null,
      p = null;
    const g = (e) => {
        ((p = e), (u = p ? Object(l["d"])(p) : null));
      },
      m = () => {
        if (window.takeOverApp)
          return ((u = window.takeOverAppMethods.getMindMapData()), u);
        if (a["a"].state.isHandleLocalFile)
          return r["default"].prototype.getCurrentData();
        if (p) {
          if (u) return u;
          const e = Object(l["d"])(p);
          if (e) return ((u = e), u);
        }
        let e = localStorage.getItem(c);
        if (null === e) return Object(i["tb"])(o["a"]);
        try {
          return JSON.parse(e);
        } catch (t) {
      ...
      T = () => {
        if (window.takeOverApp)
          return void window.takeOverAppMethods.getMindMapConfig();
      ...
      y = (e) => {
        try {
          if (window.takeOverApp)
            return void window.takeOverAppMethods.saveMindMapConfig(e);
      ...
      v = (e) => {
        window.takeOverApp
          ? window.takeOverAppMethods.saveLanguage(e)
      ...
      b = (e) => {
        if (window.takeOverApp)
          return window.takeOverAppMethods.saveLocalConfig(e);
  ...
  4013: function (e, t, n) {
    ...
    const o = {
        ...
        MODE: { READONLY: "readonly", EDIT: "edit" },
        LAYOUT: {
        ...
        KEY_DIR: { LEFT: "Left", UP: "Up", RIGHT: "Right", DOWN: "Down" },
        SHAPE: {
          RECTANGLE: "rectangle",
          DIAMOND: "diamond",
        ...
        MOUSE_WHEEL_ACTION: { ZOOM: "zoom", MOVE: "move" },
        ...
        PASTE_TYPE: { CLIP_BOARD: "clipBoard", CANVAS: "canvas" },
        SCROLL_BAR_DIR: { VERTICAL: "vertical", HORIZONTAL: "horizontal" },
        CREATE_NEW_NODE_BEHAVIOR: {
          DEFAULT: "default",
          NOT_ACTIVE: "notActive",
          ACTIVE_ONLY: "activeOnly",
        },
        TAG_PLACEMENT: { RIGHT: "right", BOTTOM: "bottom" },
        IMG_PLACEMENT: {
          LEFT: "left",
          TOP: "top",
          RIGHT: "right",
      ...
      i = {
        [o.INIT_ROOT_NODE_POSITION.LEFT]: 0,
        [o.INIT_ROOT_NODE_POSITION.TOP]: 0,
        [o.INIT_ROOT_NODE_POSITION.RIGHT]: 1,
        [o.INIT_ROOT_NODE_POSITION.BOTTOM]: 1,
        [o.INIT_ROOT_NODE_POSITION.CENTER]: 0.5,
      },
      r =
        (o.LAYOUT.LOGICAL_STRUCTURE,
        o.LAYOUT.LOGICAL_STRUCTURE_LEFT,
        o.LAYOUT.MIND_MAP,
        o.LAYOUT.ORGANIZATION_STRUCTURE,
        o.LAYOUT.CATALOG_ORGANIZATION,
        o.LAYOUT.TIMELINE,
        o.LAYOUT.TIMELINE2,
        o.LAYOUT.VERTICAL_TIMELINE,
        o.LAYOUT.VERTICAL_TIMELINE2,
        o.LAYOUT.VERTICAL_TIMELINE3,
        o.LAYOUT.FISHBONE,
        o.LAYOUT.FISHBONE2,
        o.LAYOUT.RIGHT_FISHBONE,
        o.LAYOUT.RIGHT_FISHBONE2,
        [
          o.LAYOUT.LOGICAL_STRUCTURE,
          o.LAYOUT.LOGICAL_STRUCTURE_LEFT,
          o.LAYOUT.MIND_MAP,
      ...
      l = {
        ...
        CUSTOM_HANDLE_CLIPBOARD_TEXT_ERROR:
          "custom_handle_clipboard_text_error",
      ...
      d = ["img", "br", "hr", "input", "link", "meta", "area"],
      s = 1.2,
      h = [
        "fontFamily",
        "fontSize",
  ...
  "56d7": function (e, t, n) {
    ...
    const u = [
        {
          path: "/",
          name: "Home",
          component: () => n.e("chunk-17f86c25").then(n.bind(null, "db00")),
        },
        {
          path: "/edit",
          name: "Edit",
          component: () => n.e("chunk-1b795919").then(n.bind(null, "5fca")),
        },
        { path: "/index", redirect: "/" },
        {
          path: "/doc/zh",
          component: () => n.e("chunk-3222d6ee").then(n.bind(null, "f226")),
        },
      ],
      p = new h["a"]({ routes: u });
    var g = p,
      ...
      f = n("5c96"),
      T = n.n(f),
      y = (n("0fae"), n("9c65"), n("0808"), n("c71c")),
      v = n("9225"),
      w = n("365c");
    o["default"].config.productionTip = !1;
    const b = new o["default"]();
    ((o["default"].prototype.$bus = b),
      o["default"].use(T.a),
      o["default"].use(y["a"]));
    const k = () => {
      ((v["a"].locale = Object(w["d"])()),
        new o["default"]({
          render: (e) => e(s),
          router: g,
          store: m["a"],
    ...
    window.takeOverApp ? ((window.initApp = k), (window.$bus = b)) : k();
  },
  5848: function (e, t, n) {
    "use strict";
    const o = () => ({
  ...
  9225: function (e, t, n) {
    ...
    var o = n("2b0e"),
      ...
      r = {
        ...
        setting: {
          ...
          enableAutoEnterTextEditWhenKeydown:
            "Auto enter text edit when keydown",
          confirm: "Confirm",
          cancel: "Cancel",
          changeRichTextTip:
        ...
        demonstrate: { demonstrate: "Enter demonstration mode" },
        import: {
          title: "Import",
        ...
        other: { loading: "Loading, please wait..." },
        sourceCodeEdit: {
          sourceCodeTip:
          ...
          close: "Close",
          formatErrorTip:
            "The JSON format is incorrect. Please check and try again",
        ...
        ai: {
          ...
          VolcanoArkLargeModelConfiguration:
            "Volcano Ark Large Model Configuration:",
          configTip:
      ...
      a = {
        ...
        fullscreen: { fullscreenShow: "全屏查看", fullscreenEdit: "全屏编辑" },
        demonstrate: { demonstrate: "进入演示模式" },
        import: {
          title: "导入",
          selectFile: "选取文件",
          support: "支持",
        ...
        nodeIconSidebar: { title: "图标/贴纸", icon: "图标", sticker: "贴纸" },
        formulaSidebar: {
          title: "公式",
        ...
        nodeTagStyle: { placeholder: "请输入标签内容", delete: "删除此标签" },
        ai: {
          chatTitle: "AI对话",
          clearRecords: "清空记录",
          ...
          configTip:
            "目前仅支持火山方舟大模型，需要自行去获取key，详细操作步骤见：",
          course: "教程",
      ...
      l = {
        ...
        count: { words: "字數", nodes: "節點數" },
        dialog: { cancel: "取消", confirm: "確定" },
        export: {
          title: "匯出",
          filename: "檔案名稱",
        ...
        demonstrate: { demonstrate: "進入展示模式" },
        import: {
          title: "匯入",
          selectFile: "選擇檔案",
          support: "支援",
        ...
        nodeHyperlink: { title: "超連結", link: "連結", name: "名稱" },
        nodeIcon: { title: "圖示" },
        nodeImage: { title: "圖片", imgTitle: "圖片標題" },
        nodeNote: { title: "備註" },
        nodeTag: { title: "標籤", addTip: "請按 Enter 鍵新增" },
        outline: {
          title: "大綱",
        ...
        scale: { zoomIn: "放大", zoomOut: "縮小" },
        shortcutKey: { title: "快速鍵" },
        strusture: { title: "結構" },
        style: {
          title: "節點樣式",
          normal: "常態",
        ...
        nodeIconSidebar: { title: "圖示／貼圖", icon: "圖示", sticker: "貼圖" },
        formulaSidebar: {
          title: "公式",
        ...
        nodeTagStyle: { placeholder: "請輸入標籤內容", delete: "刪除此標籤" },
        ai: {
          chatTitle: "AI對話",
          clearRecords: "清空記錄",
          ...
          VolcanoArkLargeModelConfiguration: "火山方舟大模型配置：",
          configTip:
            "目前僅支持火山方舟大模型，需要自行去獲取key，詳細操作步驟見：",
          course: "教程",
      ...
      c = {
        ...
        setting: {
          ...
          changeRichTextTip2:
            "Bạn có muốn chuyển sang chế độ văn bản phong phú?",
          changeRichTextTip3:
        ...
        count: { words: "Từ", nodes: "Nút" },
        dialog: { cancel: "Hủy", confirm: "Xác nhận" },
        export: {
          title: "Xuất",
          filename: "Tên tệp",
        ...
        demonstrate: { demonstrate: "Vào chế độ trình diễn" },
        import: {
          title: "Nhập",
          selectFile: "Chọn tệp",
          support: "Hỗ trợ",
        ...
        nodeHyperlink: { title: "Liên kết", link: "Href", name: "Tên" },
        nodeIcon: { title: "Biểu tượng" },
        nodeImage: { title: "Hình ảnh", imgTitle: "Tiêu đề" },
        nodeNote: { title: "Ghi chú" },
        nodeTag: { title: "Thẻ", addTip: "Nhấn Enter để thêm" },
        outline: {
          title: "Dàn bài",
        ...
        scale: { zoomIn: "Phóng to", zoomOut: "Thu nhỏ" },
        shortcutKey: { title: "Phím tắt" },
        strusture: { title: "Cấu trúc" },
        style: {
          title: "Kiểu nút",
          normal: "Bình thường",
          active: "Kích hoạt",
        ...
        other: { loading: "Đang tải, vui lòng đợi..." },
        sourceCodeEdit: {
          sourceCodeTip:
        ...
        ai: {
          ...
          VolcanoArkLargeModelConfiguration:
            "Cấu hình mô hình lớn Volcano Ark:",
          configTip:
          ...
          mindMappingClientConfiguration:
            "Cấu hình ứng dụng khách sơ đồ tư duy:",
          port: "Cổng",
          cancel: "Hủy",
          confirm: "Xác nhận",
          close: "Đóng",
      ...
      d = { zh: a, zhtw: l, en: r, vi: c };
    o["default"].use(i["a"]);
    const s = new i["a"]({ messages: d, fallbackLocale: "zh" });
    t["a"] = s;
  },
  "9c65": function (e, t, n) {},
  c0d6: function (e, t, n) {
    ...
    const a = new i["a"].Store({
      ...
      mutations: {
        ...
        setLocalConfig(e, t) {
          const n = Object.keys(e.aiConfig);
          (Object.keys(t).forEach((o) => {
            n.includes(o) ? (e.aiConfig[o] = t[o]) : (e.localConfig[o] = t[o]);
          }),
            Object(r["j"])({ ...e.localConfig, ...e.aiConfig }));
        },
        ...
        setExtendThemeGroupList(e, t) {
          e.extendThemeGroupList = t;
        },
        setBgList(e, t) {
          e.bgList = t;
        },
  ...
  d763: function (e, t, n) {
    ...
    const o = "MIND_MAP_FILE_LIST",
      i = "MIND_MAP_FILE_DATA_",
      r = "SIMPLE_MIND_MAP_DATA",
      a = () =>
        Date.now().toString(36) + Math.random().toString(36).substr(2, 5),
      l = (e = "新建清单") => ({
        root: { data: { text: e, checked: !1 }, children: [] },
        layout: "logicalStructure",
        theme: { template: "classic4", config: {} },
        view: null,
      }),
      ...
      d = (e) => {
        try {
          ...
          console.error("saveFileList error:", t);
        }
      },
      s = (e) => {
        try {
      ...
      u = (e = "新建清单") => {
        const t = a(),
          ...
          o = { id: t, name: e, createdAt: n, updatedAt: n },
          i = l(e),
          r = c();
        return (r.unshift(o), d(r), h(t, i), { file: o, data: i });
      },
      p = (e) => {
        const t = c().filter((t) => t.id !== e);
        d(t);
        try {
      ...
      g = (e, t) => {
        const n = c(),
          o = n.find((t) => t.id === e);
        o && ((o.name = t), (o.updatedAt = new Date().toISOString()), d(n));
      },
      m = (e) => {
        (e && e.data && void 0 === e.data.checked && (e.data.checked = !1),
          e && e.children && e.children.forEach((e) => m(e)));
      },
      f = () => {
        let e = c();
        if (0 === e.length) {
              ...
              const i = a(),
                ...
                l =
                  ...
                  void 0 === t
                    ...
                    : t.text) || "我的清单";
              return (
                (e = [{ id: i, name: l, createdAt: r, updatedAt: r }]),
                d(e),
                h(i, o),
                e
              );
      ...
      T = (e) => {
        let t = 0,
          n = 0;
        const o = (e, i = !1) => {
          (i || (t++, e.data && e.data.checked && n++),
            e.children && e.children.forEach((e) => o(e, !1)));
        };
        return (o(e, !0), { total: t, checked: n });
      };
  },
  fb21: function (e, t, n) {
    "use strict";
